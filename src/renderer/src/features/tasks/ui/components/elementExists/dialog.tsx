...
import {
  ...
  SelectorInput,
  SelectorTypeSelect,
} from '@renderer/components/selectorInput'
    ...
    >
      <DialogContent className="bg-muted max-h-11/12 overflow-y-auto scrollbar">
        <DialogHeader>
          ...
          <DialogDescription>
            Check if an element exists on the page. The flow will branch based
            on whether the element is found or not.
          </DialogDescription>
        </DialogHeader>
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              name="selector"
              render={({ field }) => (
                <FormItem className="bg-card! p-4 pb-6 pt-2 rounded-lg gap-2 flex flex-col">
                  <div className="flex items-center justify-between">
                    ...
                    <SelectorTypeSelect
                      ...
                      onValueChange={(type) =>
                        form.setValue('selectorType', type)
                      }
                    />
                  </div>
