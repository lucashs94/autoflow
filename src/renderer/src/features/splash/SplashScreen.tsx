export function SplashScreen() {
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center rounded-2xl bg-[#121212] select-none">
      ...
      <div className="h-1 w-48 overflow-hidden rounded-full bg-[#4ade80]/20">
        <div className="h-full animate-[splash-progress_1.4s_ease-in-out_infinite] rounded-full bg-[#4ade80]" />
      </div>
